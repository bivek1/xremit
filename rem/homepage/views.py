...
def Register(request):
    ...
    if request.method == 'POST':
        ...
        try:
            ...
            html_message = render_to_string('your_template_name.html', {'sub': sub, 'message':messa})
            pain_html_msg = strip_tags(html_message)
            try: 
                msg = EmailMultiAlternatives(sub, messa, content, recipient_list, fail_silently=False, auth_user=None, auth_password=None, connection=None)
